//
//  MessageCollectionViewVideoCell.swift
//  DogeChat
//
...
class MessageCollectionViewVideoCell: MessageCollectionViewBaseCell {
    
    static let cellID = "MessageCollectionViewVideoCell"
