...
@objc class VideoProcessor: NSObject {
    ...
    private let videoDownscaleFactor: Float = 3.5
...
//            VTSessionSetProperty(compressionSession, key: kVTCompressionPropertyKey_MaxKeyFrameInterval, value: frameIntervalRef)
//
//            var fps = 10
//            let fpsRef = CFNumberCreate(kCFAllocatorDefault, CFNumberType.intType, &fps)
//            VTSessionSetProperty(compressionSession, key: kVTCompressionPropertyKey_ExpectedFrameRate, value: fpsRef)
//
//            var bitRate = videoWidth * videoHeight * 3 * 4
//            let bitRateRef = CFNumberCreate(kCFAllocatorDefault, CFNumberType.sInt32Type, &bitRate)
//            VTSessionSetProperty(compressionSession, key: kVTCompressionPropertyKey_AverageBitRate, value: bitRateRef)
//
//            var bitRateLimit = videoWidth * videoHeight * 3 * 4
//            let bitRateLimitRef = CFNumberCreate(kCFAllocatorDefault, CFNumberType.sInt32Type, &bitRateLimit)
//            VTSessionSetProperty(compressionSession, key: kVTCompressionPropertyKey_DataRateLimits, value: bitRateLimitRef)
